...
extern void geth_secp256k1GoPanicIllegal(const char* msg, void* data);
extern void geth_secp256k1GoPanicError(const char* msg, void* data);
*/
import "C"
...
func init() {
	...
	context = C.geth_secp256k1_context_create_sign_verify()
	C.geth_secp256k1_context_set_illegal_callback(context, C.callbackFunc(C.geth_secp256k1GoPanicIllegal), nil)
	C.geth_secp256k1_context_set_error_callback(context, C.callbackFunc(C.geth_secp256k1GoPanicError), nil)
}
...
func Sign(msg []byte, seckey []byte) ([]byte, error) {
	...
	if C.geth_secp256k1_ec_seckey_verify(context, seckeydata) != 1 {
		return nil, ErrInvalidKey
	}
